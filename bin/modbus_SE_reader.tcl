...
for {set funcCnt 2} {$funcCnt < [expr $argc -1]} {incr funcCnt} {
    switch -- [lindex $argv $funcCnt] {
        "CommonInv" {
        ...
        default {
            puts "Unkown function [lindex $argv $funcCnt]!"
            exit 1
        }
    }
...
#
# Print data 
set outputFormat [lindex $argv [ expr $argc - 1 ]]
switch -- $outputFormat {
    "SH"    {
